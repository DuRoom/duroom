...
|-------------------------------------------------------------------------------
|
| A DuRoom site represents your local installation of DuRoom. It can be
| configured with a bunch of paths:
|
| - The *base path* is DuRoom's root directory and contains important files
...
| - The *storage path* is a place for DuRoom to store files it generates during
...
| then uses it to boot up the DuRoom application and e.g. accept web requests.
|
*/

return DuRoom\Foundation\Site::fromPaths([
    'base' => __DIR__,
